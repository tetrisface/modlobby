					...
					<Section id='account'>
						<Row>
							...
							<p class='muted'>
								...
								at startup. A server's own <b>Auto login</b>, under Servers,
								logs it in at startup or not whatever this says; set the same as
								this, it follows this again once this changes. A password never
								goes in the settings file. Forgettable on the server's setting.
							</p>
						</Row>
					</Section>
